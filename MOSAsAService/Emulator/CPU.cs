...
namespace Emulator
{
    ...
    public delegate void InstructionEvent(string log);
    
    public class CPU
    {
        public InstructionEvent OnInstructionLogged;
        ...
        private void LogInstruction(int numParams, string mnemonic, bool invalid = false)
        {
            ...
            sb.Append(",").Append($" CYC:{cyclesThisSec}");

            OnInstructionLogged?.Invoke(sb.ToString());
        }
    }
